...
export class LeadershipDichotomies extends LitElement {
  render() {
    return html`
      ...
      <p>
        In <i>Extreme Ownership</i> Jocko and Leif explained “Extreme Ownership
        [means] leaders must own everything in their world. There is no one else
        to blame.” (Willink, Babin)
      </p>
      <p>
        However, after publishing <i>Extreme Ownership</i>, Jocko and Leif
        recognized that some people who read the book were taking their message
        too literally and taking their leadership to the extreme without leaving
        room for the fine nuances of leadership. As a result, they wrote
        <i>The Dichotomy of Leadership</i> "to help leaders understand this
        challenge and find the balance needed to most effectively lead and win.
        No matter the arena, balance must be achieved for optimal performance"
        (Willink, Babin xvii).
        <br />
